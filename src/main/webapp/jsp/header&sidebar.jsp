            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="ui-resources/img/profile.png" class="user-image" alt="User Image">
                  <span class="hidden-xs">Luqman Quadri</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="ui-resources/img/profile.png" class="img-circle" alt="User Image">
                    <p>
                      Syed Luqman Quadri
        ...
        <section class="sidebar">
         ...
         <!--  <form action="#" method="get" class="sidebar-form">
          ...
          <ul class="nano-content">   
			  ...
			  <li class="list-con pop" data-toggle="popover" data-placement="right" data-html="true" data-container="body"><a href="#"><img src="ui-resources/img/profile.png" class="user-image" alt="User Image">luqman Quadri</a></li>
          	  <li class="list-con pop" data-toggle="popover" data-placement="right" data-html="true" data-container="body"><a href="#"><img src="ui-resources/img/profile.png" class="user-image" alt="User Image">luqman Quadri</a></li>
          	  <li class="list-con pop" data-toggle="popover" data-placement="right" data-html="true" data-container="body"><a href="#"><img src="ui-resources/img/profile.png" class="user-image" alt="User Image">luqman Quadri</a></li>
          	  <li class="list-con pop" data-toggle="popover" data-placement="right" data-html="true" data-container="body"><a href="#"><img src="ui-resources/img/profile.png" class="user-image" alt="User Image">luqman Quadri</a></li>
          	  <li class="list-con pop" data-toggle="popover" data-placement="right" data-html="true" data-container="body"><a href="#"><img src="ui-resources/img/profile.png" class="user-image" alt="User Image">luqman Quadri</a></li>
